<?php
include('../../../base/inc/filmsAssociatif.php');
$film=3;
include('nav.php');
...
?>
  <main class="right">
    ...
    <h2 class="right__title">Critique de Batman The Dark knight</h2>
    <div class="posts">
      <article class="post">
        ...
        <a href="../inc/article.php" class="post__link">Continue reading</a>
      </article>
      <article class="post">
        ...
        <a href="../inc/article2.php" class="post__link">Continue reading</a>
      </article>
      <article class="post">
        <a href="" class="post__category post__category--color-news">news</a>
        <h3>Lorem ipsum dolor sit amet</h3>
        ...
        <a href="../inc/article3.php" class="post__link">Continue reading</a>
      </article>
      <article class="post">
        ...
        <a href="../inc/article4.php" class="post__link">Continue reading</a>
      </article>
      <article class="post">
        <a href="" class="post__category post__category--color-team">team</a>
        <h3>Lorem ipsum dolor sit amet</h3>
        ...
        <a href="../inc/article5.php" class="post__link">Continue reading</a>
      </article>
      <article class="post">
        <a href="" class="post__category post__category--color-work">work</a>
        <h3>Lorem ipsum dolor sit amet</h3>
        ...
        <a href="../inc/article6.php" class="post__link">Continue reading</a>
      </article>
